...
export default function Footer() {
  return (
    <footer className="bg-alfa-blue-dark text-white">
      {/* Main footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              <a href={company.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-alfa-gold transition-colors">
              ...
              <a href={company.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-alfa-gold transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href={company.googleReview} target="_blank" rel="noopener noreferrer" aria-label="Google Reviews" className="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-alfa-gold transition-colors">
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-alfa-gold">Our Services</h3>
          ...
          {/* Cities */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-alfa-gold">Service Areas</h3>
            <ul className="space-y-2">
              {cityLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-gray-300 hover:text-white transition-colors">
          ...
          {/* Blog & Contact */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-alfa-gold">Recent Posts</h3>
            ...
            <Link
              href="/contact"
              className="inline-block bg-alfa-gold hover:bg-alfa-gold-dark text-white font-semibold px-6 py-3 rounded-lg transition-all duration-300 hover:shadow-lg text-sm"
            >
              Get Free Estimate
            </Link>
          </div>
