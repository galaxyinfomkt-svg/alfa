    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-2 flex justify-between items-center">
          {/* Left — Location (hidden on phones so the email fits) */}
          ...
          <a
            ...
            className="flex items-center gap-1.5 text-[11px] sm:text-sm font-medium whitespace-nowrap hover:text-black/70 transition-colors"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <a href={company.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="inline-flex items-center justify-center w-6 h-6 hover:text-black/70 transition-colors">
              ...
              <a href={company.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="inline-flex items-center justify-center w-6 h-6 hover:text-black/70 transition-colors">
