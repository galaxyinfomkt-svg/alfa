...
export default function Header() {
  ...
  return (
    ...
    >
      {/* Gold Top Bar — RS Development style */}
      <div
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <a
                href={company.phoneTel}
                className="flex items-center gap-2 bg-alfa-gold hover:bg-alfa-gold-light text-black font-bold px-5 py-2.5 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-alfa-gold/20 text-sm phone-pulse"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
