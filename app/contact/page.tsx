  ...
  return (
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Info */}
            <div>
              <h2 className="text-2xl font-bold text-alfa-blue mb-6">Get in Touch</h2>
              <div className="space-y-6 mb-8">
                <a href={company.phoneTel} className="flex items-start gap-4 group">
                  ...
                  <div>
                    <p className="font-semibold text-alfa-blue">Phone</p>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-alfa-blue/10 rounded-xl flex items-center justify-center shrink-0">
                    <svg className="w-6 h-6 text-alfa-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  </div>
                  <div>
                    <p className="font-semibold text-alfa-blue">Location</p>
                    <p className="text-gray-700">{company.address.full}</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-alfa-blue">Hours</p>
                    <p className="text-gray-700">{company.hours}</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-alfa-blue">License</p>
                    <p className="text-gray-700">MA License {company.license}</p>
              ...
              <div className="flex gap-3">
                <a href={company.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-alfa-blue rounded-lg flex items-center justify-center text-white hover:bg-alfa-gold transition-colors" aria-label="Instagram">
                ...
                <a href={company.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-alfa-blue rounded-lg flex items-center justify-center text-white hover:bg-alfa-gold transition-colors" aria-label="Facebook">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href={company.googleReview} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-alfa-blue rounded-lg flex items-center justify-center text-white hover:bg-alfa-gold transition-colors" aria-label="Google Reviews">
            ...
            {/* Form */}
            <div className="bg-alfa-gray rounded-2xl p-8 shadow-sm">
              <h2 className="text-2xl font-bold text-alfa-blue mb-4 text-center">
      ...
      <section className="py-16 bg-alfa-gray">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-alfa-blue text-center mb-8">Find Us</h2>
          <GoogleMap />
        </div>
      </section>
    </>
