        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div>
              ...
              {/* CTA no hero.
                  Estas 981 paginas nao tinham nenhum botao aqui: iam do H1
                  direto para as credenciais, e o primeiro CTA de peso do
                  conteudo aparecia so a 12.716px de scroll — 15 telas de
                  celular, numa pagina de 18,9 telas. Este e o mesmo par que
                  /services/[slug] ja usa, onde o primeiro CTA cai a 0,9 tela. */}
