    ...
    <>
      <section className="pt-32 pb-16 bg-alfa-blue">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex items-center gap-3">
            <span className="bg-alfa-gold text-white text-xs font-semibold px-3 py-1 rounded-full">{project.service}</span>
            <span className="text-gray-300 text-sm">{project.city}, {project.state}</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          {project.beforeImage && project.afterImage && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div>
                <h3 className="font-bold text-alfa-blue mb-2 text-center">Before</h3>
              ...
              <div>
                <h3 className="font-bold text-alfa-blue mb-2 text-center">After</h3>
                <div className="aspect-[4/3] relative rounded-xl overflow-hidden shadow-md">
          ...
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-alfa-blue mb-4">About This Project</h2>
      ...
      {relatedProjects.length > 0 && (
        <section className="py-16 bg-alfa-gray">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-2xl font-bold text-alfa-blue mb-8 text-center">Related Projects</h2>
              ...
              {relatedProjects.map((rp) => (
                <Link key={rp.slug} href={`/projects/${rp.slug}`} className="group block">
                  <div className="card-hover bg-white rounded-2xl overflow-hidden shadow-md">
                    ...
                    <div className="p-5">
                      <h3 className="font-bold text-alfa-blue group-hover:text-alfa-gold transition-colors">{rp.title}</h3>
                    </div>
                  </div>
                </Link>
              ))}
